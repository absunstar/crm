app.controller("employees_advances_fin", function ($scope, $http) {
  ...
  $scope.newemployees_advances_fin = function () {
    ...
    site.showModal('#addemployees_advances_finModal');
  };
  ...
  $scope.add = function () {
    ...
    $http({
      ...
      function (response) {
        $scope.busy = false;
        if (response.data.done) {
          site.hideModal('#addemployees_advances_finModal');
          $scope.loadAll();
        } else {
          $scope.error = '##word.error##';
        }
  ...
  $scope.edit = function (employees_advances_fin) {
    ...
    $scope.employees_advances_fin = {};
    site.showModal('#updateemployees_advances_finModal');
  };
  ...
  $scope.update = function () {
    ...
    $http({
      ...
      function (response) {
        $scope.busy = false;
        if (response.data.done) {
          site.hideModal('#updateemployees_advances_finModal');
          $scope.loadAll();
        } else {
          $scope.error = '##word.error##';
        }
  ...
  $scope.remove = function (employees_advances_fin) {
    $scope.view(employees_advances_fin);
    $scope.employees_advances_fin = {};
    site.showModal('#deleteemployees_advances_finModal');
  };
  ...
  $scope.details = function (employees_advances_fin) {
    $scope.view(employees_advances_fin);
    $scope.employees_advances_fin = {};
    site.showModal('#viewemployees_advances_finModal');
  };
  $scope.delete = function () {
    ...
    $http({
      ...
      function (response) {
        $scope.busy = false;
        if (response.data.done) {
          site.hideModal('#deleteemployees_advances_finModal');
          $scope.loadAll();
        } else {
          $scope.error = response.data.error;
        }
